...
export const idFilterDropdownHeader = "elem_" + generateId(15);
...
export const idAbUploadBtn = "elem_" + generateId(15);
...
export const idAbToggleRunner = "elem_" + generateId(15);
...
export const idAbQuickSell = "elem_" + generateId(15);
export const idAbAddFilterBC = "elem_" + generateId(15);
